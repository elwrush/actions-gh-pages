...
// ==========================================
// GRAMMAR REPAIR WORKSHEET - V9 (PRINTER SAFE)
// ==========================================
#set page(
  paper: "a4",
...
#let integrated_header() = {
  ...
  block(
    width: 100%,
    height: 1.5cm, // Enlarged by 25% (1.2 * 1.25)
    fill: maroon,
    ...
    align(horizon + left)[
      #stack(
        dir: ltr,
        spacing: 1.25em, // Increased spacing
        image("/images/ACT_transparent.png", height: 0.75cm), // Enlarged by 25%
        image("/images/Bell.svg", height: 0.75cm), // Enlarged by 25%
        h(0.2cm),
        text(fill: white, size: 10.5pt, weight: "bold", tracking: 0.05em)[ // Tightened tracking slightly to ensure single-line
  ...
  v(0.6cm) // Slightly less spacer below to account for larger bar
}
