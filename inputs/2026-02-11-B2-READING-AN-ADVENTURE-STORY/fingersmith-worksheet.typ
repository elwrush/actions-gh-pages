...
// ============================================================
// BELL BRANDED WORKSHEET: FINGERSMITH - THE HITCHHIKER
// ============================================================
...
#set page(
  ...
  footer: align(center, context text(size: 9pt, fill: slate-dark)[Page #counter(page).display()]),
)
  ...
  block(
    ...
    align(horizon + left)[
      #stack(
        ...
        image("/images/Bell.png", height: 0.75cm),
        h(0.2cm),
...
#let instructions(body) = {
  text(size: 10pt, style: "italic", fill: slate-dark, body)
}
...
#let question(text, points: "") = {
  block(width: 100%, inset: (top: 0.4em, bottom: 0.6em), [
    #text #h(1fr) #emph[#points] \
    #v(0.9cm)
    #line(length: 100%, stroke: 0.5pt + gray-line)
  ])
}

// STORY PARAGRAPH STYLE
#let paragraph(num, body) = {
  grid(
    columns: (25pt, 1fr),
    gutter: 10pt,
    align(right, text(size: 11pt, fill: maroon, weight: "bold")[#num]),
    body
  )
  v(0.15cm)
}
...
#task_tab("3", "DEEP DISCUSSION")

#instructions([Working in small groups, discuss the following questions. Be prepared to share your ideas with the class.])

#v(0.4cm)
- *The Morality of the 'Fingersmith'*: The hitchhiker says he only steals from "the winners and the rich" and never from "poor people" or his "pals". Does this "Robin Hood" mentality make his actions more acceptable?
- *The Narrator's Reaction*: At the end, the narrator is "excited" and calls the hitchhiker a "genius". Does this suggest he has abandoned his own moral compass?
- *Risk and Reward*: Both men were taking risks. Who took the bigger risk, and how does the ending change your view of the danger?
...
#pagebreak()
#text(weight: "bold", size: 14pt, fill: maroon)[TEACHER'S ANSWER KEY]
#v(0.5cm)

#text(weight: "bold")[Task 1: Prediction & Gist]
1. *Car Facts*: BMW 3.3 Li. 3.3 litre, long wheelbase, fuel injection. Top speed 129 mph.
2. *Sympathy*: The narrator used to be a hitchhiker and hated it when people didn't stop for him.
3. *Opinion*: He thinks the narrator is a "nosy" rich person but respects his "skilled trade" of writing.

#v(0.4cm)
#text(weight: "bold")[Task 2: Comprehension & Analysis]
1. *Car*: BMW 3.3 Li. Top speed: 129 mph.
2. *Feeling*: He remembers how it feels to stand on the road waiting for a car.
3. *Skill*: He picks several items from the narrator's pockets (belt, watch, diary) to prove how quick his fingers are.
4. *Bias*: The cop is described as "meaty" and "mean," while the hitchhiker is "clever" and "quick" like a rat.
5. *Crime vs Skill*: Most students will say it is a crime, but the character believes his skill makes him different from ordinary thieves.
6. *Reason*: The hitchhiker's bet ("Car-makers is liars") tricked the narrator into proving how fast his car could go.
7. *Ending*: The policeman is left with no evidence against them because his books are stolen.
