...
#stage_table((
  stage(
    ...
    [
      - Show the introductory visual to set the context of spelling vs sound.
  ...
  stage(
    ...
    [
      - T-S: Present 3 essential terms for the lesson using the vocabulary overview visuals:
  ...
  stage(
    ...
    [
      - Display the Consonants chart. Introduce the "Finger on Throat" technique.
      - Elicit: Students say /p/ (Quiet) then /b/ (Loud). Ask: "Which one makes your throat vibrate?" (Voiced /b/).
      - T-S Action: Direct students to the blue (Unvoiced) and orange (Voiced) color coding on their charts. 
  ...
  stage(
    ...
    [
      - Display the Vowel & Diphthong chart. Highlight the "Alphabet Names" (A, E, I, O, U).
  ...
  stage(
    ...
    [
      - Display the transcription instructions. T-S: Explain that the chart is 'The Map' to escape 'The Lie' of spelling.
      ...
      - Feedback: Reveal the answer visual. Students self-correct and reflect on which symbols were the hardest to 'read'. Elicit: "Did the map help you catch the difference between Tom and Tim?"
    ],
    "Indiv"
  ),
  stage(
    ...
    "Refine the skill",
    [
      - Display the Word Sort and Ticking tasks. 
      - Task (Individual): Students listen to 10 words and tick /ɒ/, /ɔː/, or /əʊ/.
      - Comparison (Ss-Ss): Students compare their sorting results in pairs before the teacher reveals the answer visual.
  ...
  stage(
    ...
    [
      - Show the instructions for the final activity. Explain "THE SECRET CODE SWAP."
      - Task (Pairs): Students write one "Secret Sentence" about their classroom or partner (e.g., "Paul has a black pen") but DO NOT show anyone.
...
#answer_key([
  #strong[Task 1 (Transcription):] 1. Tom likes writing poetry. 2. Jane's got a friendly brown pet cat. 3. Sue was fast asleep when the burglars came. 4. Joe bought a bottle of Hungarian wine last night. 5. Liz wants to be rich and famous one day. 6. Paul's a wealthy young tourist. 7. Tom and Liz are good at Spanish. 8. Joe works in a noisy garage. \
  \
  #strong[Task 2 (Listen & Tick):] 1. clock (/ɒ/), 2. sport (/ɔː/), 3. boat (/əʊ/), 4. saw (/ɔː/), 5. got (/ɒ/), 6. joke (/əʊ/), 7. box (/ɒ/), 8. shown (/əʊ/), 9. born (/ɔː/), 10. coat (/əʊ/). \
  \
  #strong[Task 3 (Categorization):] 
