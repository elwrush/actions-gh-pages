# SOURCE_TEXT: Digital Influence & The Generation Gap

## Metadata
- **Source**: Oxford Discover Futures 3, Workbook p.9
- **Topic**: Teenagers, Parents, and Media Influence
- **CEFR**: B1
- **Audio ID**: 1.01 (Tom's World Podcast)
...
## Exercises
- **Ex 1**: Main topic (Teenagers and their parents).
- **Ex 2**: What does Dr. Schmidt do? (Psychologist studying teenagers and media).
- **Ex 3 (MCQ)**: 1-b, 2-d, 3-d, 4-a, 5-c.
- **Ex 4 (Matching)**: 1-a, 2-g, 3-d, 4-c, 5-f, 6-e, 7-b.
- **Ex 5 (Speaking)**: Discussing influence in education, finance, health, and well-being.
