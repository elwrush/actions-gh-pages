...
## The Tool: `.agent/skills/05-processing-images/scripts/trim_image.py`
Use this script to auto-process images.

### Usage
```bash
python .agent/skills/05-processing-images/scripts/trim_image.py <input> <output> [options]
```
...
python .agent/skills/05-processing-images/scripts/trim_image.py "images/generated_title.jpg" "images/header_final.png" --padding 10 --threshold 230 --transparent
```
...
2.  Trim and transparentize:
    ```bash
    python .agent/skills/05-processing-images/scripts/trim_image.py "images/separator_raw.jpg" "images/separator.png" --padding 0 --threshold 220 --transparent
    ```
...
```bash
python .agent/skills/05-processing-images/scripts/remove_checkerboard.py "images/fake_png.png" "images/clean_output.png"
```
